      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Get up and running with our dental PMS connector in just a few simple steps. Our team handles the technical setup so you can focus on your business.
          </p>
        </div>
                  ...
                  <CardHeader>
                    <div className="flex items-center mb-4">
                      ...
                      <div>
                        ...
                        <CardTitle className="text-xl" data-testid={`step-title-${step.step}`}>{step.title}</CardTitle>
                      </div>
                    </div>
        ...
        <div className="bg-gray-50 rounded-2xl p-8 mb-20">
          <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">Setup Timeline</h2>
                ...
                <div className="flex items-center">
                  <div className="flex-1 text-right pr-8">
                    <div className="bg-white rounded-lg p-4 shadow-sm">
                      ...
                      <div className="text-sm text-gray-600">Initial consultation call</div>
                    </div>
                  </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="flex-1 text-left pl-8">
                    <div className="bg-white rounded-lg p-4 shadow-sm">
                      ...
                      <div className="text-sm text-gray-600">App installation & configuration</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  <div className="flex-1 text-right pr-8">
                    <div className="bg-white rounded-lg p-4 shadow-sm">
                      ...
                      <div className="text-sm text-gray-600">Testing & verification</div>
                    </div>
                  </div>
                  <div className="w-4 h-4 bg-primary rounded-full relative z-10"></div>
                  <div className="flex-1 pl-8"></div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="flex-1 text-left pl-8">
                    <div className="bg-white rounded-lg p-4 shadow-sm border-green-200">
                      ...
                      <div className="text-sm text-gray-600">Go live with real-time sync</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-primary rounded-2xl p-8 text-center text-white mb-20">
          ...
          <p className="text-blue-100 mb-6">Book your setup call today and be syncing data within 3 business days.</p>
          <Button size="lg" className="bg-white text-primary hover:bg-gray-100" data-testid="button-book-setup-call">
            Book Setup Call
          </Button>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Onboarding FAQ</h2>
            <p className="text-gray-600">Common questions about our setup process</p>
          </div>
          <FAQ items={faqItems} />
        </div>
      </div>
