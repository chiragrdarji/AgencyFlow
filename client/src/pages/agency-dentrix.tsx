...
export default function DentrixIntegration() {
  const metaTags = getMetaTags('dentrixIntegration');

  const breadcrumbSchema = getBreadcrumbSchema([
    { name: 'Home', url: 'https://smartsync.one/' },
    { name: 'Dentrix Integration', url: 'https://smartsync.one/dentrix-gohighlevel-integration' },
  ]);

  const faqItems = [
    {
      question: "What is a PMS API?",
      answer: "A PMS API is a secure interface that allows dental practice management systems to sync data with external tools like CRMs.",
    },
    {
      question: "Do we support Dentrix Ascend API?",
      answer: "Yes, we currently support the Dentrix Ascend API.",
    },
    {
    ...
    },
    {
      ...
      answer: "Most recent versions of Dentrix are supported. Contact us for version-specific compatibility.",
    },
    {
      question: "How can I get started?",
      answer: 'Click the "Connect Dentrix to GHL" button or visit our Marketplace listing to begin.',
    },
    {
      question: "How much does the Dentrix to GoHighLevel integration cost?",
      answer: "Pricing starts at $150 per Dentrix instance per month and goes up to $200, depending on the plan.",
    },
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Dentrix Integration FAQ
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Get answers to common questions about integrating Dentrix with GoHighLevel
            </p>
          </div>
          <FAQ items={faqItems} />
        </div>
