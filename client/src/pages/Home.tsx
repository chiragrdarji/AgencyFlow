            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                >
                  ...
                  Dentrix/Open Dental and GoHighLevel so you can focus on
                  growing your clients' practices.
                </p>
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700 w-fit">
                        Run smarter, data-driven campaigns with real-time
                        patient info
                      </span>
                    </li>
                    <li className="flex items-start">
                    ...
                    <li className="flex items-start">
                      ...
                      />
                      <span className="text-gray-700 w-fit">
                        Provide new patients, reactivations, appointments
                        booked, and revenue generated to dental practices
                      </span>
                    </li>
                  </ul>
                </CardContent>
                ...
                <div className="space-y-8">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Automatically sync patients, providers, appointments,
                        and payments between Dentrix and GoHighLevel in
                        real-time.
                      </p>
                    </div>
                  </div>
