          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature: any, index: any) => (
              <Card key={index} className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-slate-100">
                <div className={` rounded-lg  h-16 flex items-center text-center justify-center mb-6`}>
                ...
                <h3 className="text-xl text-center font-bold text-slate-900 mb-3">{feature.title}</h3>
      ...
      <section className="py-20  bg-slate-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Everything you need to know about our {integration} to gohighlevel-integration.
            </p>
          </div>
          <FAQ items={faqItems} />
        </div>
