...
(function () {
  ...
  addJsonLd({
    ...
    "description": "Two-way sync of patients, appointments, providers, and payments between Open Dental (including Ascend/Enterprise) and your CRM.",
    "featureList": [
